    ...
    <div className="space-y-16">
      ...
      <section className="text-center py-12 px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Manage Tasks & Learn New Skills with <span className="text-purple-600">LearnTrack</span>
        </h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose LearnTrack?</h2>
      ...
      <section className="py-12 bg-purple-600 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already managing their tasks and learning new skills with LearnTrack.
          </p>
