...
export default function PendingTasksPage() {
  ...
  const filteredTasks = tasks
    .filter(task => task.status === "pending") // first filter only pending
    .filter(task => 
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <select
          ...
          className="form-select mt-2 w-full py-2 px-3 bg-indigo-100 border border-indigo-300 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
        >
